...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_pfn5uv1', 'template_mebatbd', fromRef.current, {
            publicKey: 'Of22-qRLxI5dkglAg',
          })
          .then(
            () => {
                setSuccess(true)
    ...
    return (
        <motion.div
            ...
            <motion.div className="textContainer" variants={variants}>
                <motion.h1 variants={variants}> <motion.b whileInView={{color:"orange"}}>Let's </motion.b> Work Together</motion.h1>
                <motion.div className="item" variants={variants}>
                    <motion.h2 whileHover={{color:"orange"}}>Email</motion.h2>
                    <span>shubhadeepnandi03@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <motion.h2 whileHover={{color:"orange"}}>Address</motion.h2>
                    <span>Shashpur, Indas, Bankura, WB, India, 722205</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <motion.h2 whileHover={{color:"orange"}}>Phone</motion.h2>
                    <span>+91 7679485627</span>
                </motion.div>
            </motion.div>
            <motion.div className="formContainer">
                ...
                <motion.form ref={fromRef} onSubmit={sendEmail} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 4, duration: 1 }}>
                    ...
                    <textarea rows={8} required placeholder='What You Want To Say'  name="message"/>
